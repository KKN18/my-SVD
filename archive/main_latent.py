...
start_timestep = 15
frames = pipe(images, decode_chunk_size=1, num_frames=7, generator=generator, start_timestep=start_timestep).frames[0]

save_path = f"/home/nas2_userG/junhahyung/kkn/my-svd/outputs/main_latent/time_step_{start_timestep}"
